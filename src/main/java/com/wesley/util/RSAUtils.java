...
public abstract class RSAUtils {
	...
	static {
		try {
			keyPairGen = KeyPairGenerator.getInstance(ALGORITHM, DEFAULT_PROVIDER);
	 ...
	 * @return 给定字符串的密文。
	 */
	public static String encryptString(String plaintext) throws IOException {
		if (plaintext == null) {
			return null;
		}
		byte[] data = plaintext.getBytes();
	 ...
	 * @return 原文字符串。
	 */
	public static String decryptString(String encrypttext) throws IOException {
	 ...
	 */
	public static String decryptStringByJs(String encryptText) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static RSAPublicKey getDefaultPublicKey() throws IOException {
		KeyPair keyPair = getKeyPair();
		if (keyPair != null) {
	 ...
	 * @throws IOException
	 */
	public static RSAPrivateKey getDefaultPrivateKey() throws IOException {
		KeyPair keyPair = getKeyPair();
		if (keyPair != null) {
	...
	public static PublicKeyMap getPublicKeyMap() throws IOException {
